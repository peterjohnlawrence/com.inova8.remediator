 ...
 * @version $Revision$
 */
public class RemediatorQueryExecutionPerformanceTest extends TestCase {
	 ...
	 */
	public RemediatorQueryExecutionPerformanceTest(String name) {
		super(name);
	}
	...
	public void queryExecute(Integer testNumber) throws Exception {
		String rewrittenQueryString = readFile(path + queryFolder + "/test"
				+ testNumber + "/rewrite.txt", Charset.defaultCharset());
		for (numberRuns = 0; numberRuns < 10; numberRuns++) {
			QueryExecution queryExecution = RemediatorQueryExecutionFactory
					.create(rewrittenQueryString);
