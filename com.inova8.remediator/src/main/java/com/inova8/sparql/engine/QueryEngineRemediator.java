 ...
 *  algebra extensions. 
 */
public class QueryEngineRemediator extends QueryEngineBase
{
    public QueryEngineRemediator(Op op, DatasetGraph dataset, Context context)
    { this(op, dataset, BindingFactory.root(), context) ; }
    
    public QueryEngineRemediator(Op op, DatasetGraph dataset, Binding input, Context context)
    { super(op, dataset, input, context) ; }

    protected QueryEngineRemediator(Query query, DatasetGraph dataset,
    ...
    private static QueryEngineFactory factory = new QueryEngineFactory()
    {
        ...
        {
            QueryEngineRemediator engine = new QueryEngineRemediator(op, dataset, binding, context) ;
            return engine.getPlan() ;
        }
